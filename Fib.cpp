...
public:
	...
	int getMinimum() { return heap->value; }
	...
	void decreaseKey(node* n, int value) { heap = _decreaseKey(heap, n, value); }

	node* find(int value) { return _find(heap, value); }
private:
	node * _empty() { return NULL; }
